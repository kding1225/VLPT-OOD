...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.COOP.TEST_TIME_FUSE = ""
    cfg.TRAINER.COOP.TEST_TIME_WEIGHT = 1.0
    ...
    cfg.TRAINER.PROGRAD.CTX_INIT = ""  # initialization words
    ...
    cfg.TRAINER.PROGRAD.TEST_TIME_FUSE = ""
    cfg.TRAINER.PROGRAD.TEST_TIME_WEIGHT = 1.0
    ...
    cfg.TRAINER.KGCOOP.W = 8.0
    cfg.TRAINER.KGCOOP.TEST_TIME_FUSE = ""
    cfg.TRAINER.KGCOOP.TEST_TIME_WEIGHT = 1.0
